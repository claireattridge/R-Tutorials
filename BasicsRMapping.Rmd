...
First we will download a .zip file from my online Github repository to your local folder/project.
We will then unzip the shapefile items into your local folder/project.

For this example, the .zip contains the shapefile of coastal British Columbia from the Hakai Institute (Daniel Okamoto, Jenn Burt), accessible via Github (https://github.com/HakaiInstitute/hakai_guide_to_r/tree/master/data/2_Shapefile).

I tend to make use of the "here()" package to create a reproducible workflow.
